    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="javascript:;"><i class="la la-print"></i><span class="menu-title">المرشحين</span></a>
                <ul class="menu-content">
                    @can('Read-Nominates')<li><a class="menu-item" href="{{route('nominates.index')}}"><i></i><span>عرض الجميع</span></a></li>@endcan
                    @can('Create-Nominate')<li><a class="menu-item" href="{{route('nominates.create')}}"><i></i><span>شاشة الترشيح</span></a></li>@endcan

                    @can('Update-Nominate')<li><a class="menu-item" href="{{route('nominates.importExcelForm')}}"><i></i><span>تحديث حالة المستفيد Excel</span></a>
                    </li>@endcan
