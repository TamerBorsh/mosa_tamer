                        ...
                        <form class="form" id="addDataForm" method="post">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <fieldset class="form-group position-relative">
                                                <label for="projectinput2">المنطقة</label>
                                                <select class="form-control" id="DefaultSelect" name="region_id" require>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput2">اسم المسجد</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <fieldset class="form-group position-relative">
                                                ...
                                                <select class="form-control" id="region_id" name="region_id" require>
                                                    <option selected="">اختر المنطقة</option>
                                                    @foreach ($regions as $region)
                                                    <option value="{{$region->id}}">{{$region->name}}</option>
                                                    @endforeach
...
<script>
    ...
    $('body').on('click', '#editRow', function() {
        ...
        axios.get("{{ url('/') }}" + '/dash/mosques/' + id + '/edit')
        ...
        $("#updateDataForm").on('submit', function(e) {
            e.preventDefault();
            var method = "post";
            var storeUrl = "{{ route('mosques.updateData') }}";
            var formData = new FormData(this) // OR new FormData($('#addDataForm')[0]);
            var formId = "";
            var reload = "#mosque-table";
    ...
    // =============================
    $('body').on('click', '#deleteMosque', function(e) {
        e.preventDefault();
        let id = $(this).data('id');
        var deleteUrl = "{{ url('/') }}" + '/dash/mosques/' + id;
        var reload = "#mosque-table";
        var to_route = "#";
